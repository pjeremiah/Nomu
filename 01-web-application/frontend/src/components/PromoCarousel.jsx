...
const PromoCarousel = () => {
  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      ...
      if (currentIndex === promos.length - 1) {
        // Going from last to first - animate to the duplicate first card
        setCurrentIndex(promos.length); // This is the duplicate first card at the end
        
        // After animation, reset to actual first card
        setTimeout(() => {
          setCurrentIndex(0);
  ...
  const prevSlide = () => {
    ...
    if (currentIndex === 0) {
      // Going from first to last - animate to the duplicate last card
      setCurrentIndex(-1); // This is the duplicate last card at the beginning
      
      // After animation, reset to actual last card
      setTimeout(() => {
