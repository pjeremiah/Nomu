        ...
        <div style={{ display: 'flex', alignItems: 'center' }}>
          ...
          <div>
            ...
            <p style={{ margin: '0.5rem 0 0 0', color: '#6c757d', fontSize: '1rem' }}>
              Manage stock levels, track movements, and monitor inventory
            </p>
          </div>
        </div>
      </div>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
            ...
            <div>
              ...
              <div style={{ fontSize: '0.9rem', color: '#6c757d' }}>Low Stock</div>
            </div>
          </div>
        </div>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
            ...
            <div>
              ...
              <div style={{ fontSize: '0.9rem', color: '#6c757d' }}>Out of Stock</div>
            </div>
          </div>
        </div>
