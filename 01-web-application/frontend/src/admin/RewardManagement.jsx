  ...
  return (
    ...
    >
        ...
        <div style={{ 
          ...
          }}>{editing ? "Edit Reward" : "Add New Reward"}</h3>
          <button
            onClick={() => {
        ...
        <form className="admin-form" style={{ flex: 1, padding: '1rem', display: 'flex', flexDirection: 'column' }}>
  ...
  return (
    <div style={{
      ...
      <PageHeader 
        ...
        icon={Gift}
        description="Configure rewards and loyalty programs"
      />
        ...
        >
          <div
            style={{
              ...
              placeItems: 'center',
              borderRadius: 10,
                background: status === 'Active' ? 'rgba(46, 175, 74, 0.12)' : 
                           status === 'Inactive' ? 'rgba(108, 117, 125, 0.12)' :
                           status === 'Scheduled' ? 'rgba(255, 193, 7, 0.12)' :
                           'rgba(220, 53, 69, 0.12)',
                color: status === 'Active' ? '#2eaf4a' : 
          ...
          <div>
              ...
              <div style={{ fontWeight: 700, fontSize: 28, color: '#17337E' }}>{statusCounts[status]}</div>
            </div>
          </div>
        ))}
        </div>
